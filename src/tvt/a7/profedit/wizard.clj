...
(def ^:private distance-presets
  {:subsonic
   ...
   {:distances
    (mapv double
          [100 200 250 300 350 400 450 500 520 540 560 580 600 620 640 660 680 700
           720 740 760 780 800 820 840 860 880 900 920 940 960 980 1000 1010 1020
           ...
           1450 1460 1470 1480 1490 1500 1505 1510 1515 1520 1525 1530 1535 1540
              ...
              :center (sc/vertical-panel
                       :items [selected
                               ...
                               (sc/radio :id :long-range
                                         :text ::distance-preset-long-range
                                         :margin 20
                                         :group group)
                               (sc/radio :id :ultra-range
                                         :text ::distance-preset-ultra-range
                                         :margin 20
                                         :group group)]))]
    (sc/listen group
               :selection
